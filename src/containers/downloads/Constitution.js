...
let Constitution = () => {
    ...
    let url = 'https://kpsiaj.org/wp-content/uploads/2019/08/Constitution_and_Bye_Laws.pdf'
    const renderButtons = () => {
...
const styles = StyleSheet.create({
    ...
    btn: { flex: 1, backgroundColor: '#ECEAE4', height: 50, justifyContent: 'center', alignItems: 'center', elevation: 5 },
